...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Model.cumulus_pallet_xcmp_queue
{
    ...
    /// <summary>
    /// >> 419 - Composite[cumulus_pallet_xcmp_queue.QueueConfigData]
    /// </summary>
    ...
    public sealed class QueueConfigData : BaseType
    {
        ...
        /// >> threshold_weight
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight ThresholdWeight { get; set; }
        /// <summary>
        /// >> weight_restrict_decay
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight WeightRestrictDecay { get; set; }
        /// <summary>
        /// >> xcmp_max_individual_weight
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight XcmpMaxIndividualWeight { get; set; }
        ...
        public override void Decode(byte[] byteArray, ref int p)
        {
            ...
            ThresholdWeight = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            ThresholdWeight.Decode(byteArray, ref p);
            WeightRestrictDecay = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
            WeightRestrictDecay.Decode(byteArray, ref p);
            XcmpMaxIndividualWeight = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_weights.weight_v2.Weight();
