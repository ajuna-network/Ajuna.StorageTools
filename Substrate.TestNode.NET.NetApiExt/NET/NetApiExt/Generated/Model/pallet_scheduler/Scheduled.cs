...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_scheduler
{
    
    
    /// <summary>
    /// >> 368 - Composite[pallet_scheduler.Scheduled]
    /// </summary>
    ...
    public sealed class Scheduled : BaseType
    {
        ...
        /// >> maybe_id
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.TestNode.NET.NetApiExt.Generated.Types.Base.Arr32U8> MaybeId { get; set; }
        /// <summary>
        /// >> priority
        /// </summary>
        ...
        /// >> call
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded Call { get; set; }
        /// <summary>
        /// >> maybe_periodic
        /// </summary>
        ...
        /// >> origin
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.EnumOriginCaller Origin { get; set; }
        ...
        {
            var start = p;
            MaybeId = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.TestNode.NET.NetApiExt.Generated.Types.Base.Arr32U8>();
            MaybeId.Decode(byteArray, ref p);
            Priority = new Substrate.NetApi.Model.Types.Primitive.U8();
            Priority.Decode(byteArray, ref p);
            Call = new Substrate.TestNode.NET.NetApiExt.Generated.Model.frame_support.traits.preimages.EnumBounded();
            ...
            Origin = new Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.EnumOriginCaller();
