...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_treasury
{
    ...
    public sealed class Proposal : BaseType
    {
        ...
        /// >> proposer
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Proposer { get; set; }
        /// <summary>
        /// >> value
        /// </summary>
        ...
        /// >> beneficiary
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Beneficiary { get; set; }
        /// <summary>
        /// >> bond
        /// </summary>
        ...
        {
            var start = p;
            Proposer = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Proposer.Decode(byteArray, ref p);
            Value = new Substrate.NetApi.Model.Types.Primitive.U128();
            Value.Decode(byteArray, ref p);
            Beneficiary = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
