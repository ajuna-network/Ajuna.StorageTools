...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_nfts.types
{
    ...
    /// <summary>
    /// >> 328 - Composite[pallet_nfts.types.MintWitness]
    /// </summary>
    ...
    public sealed class MintWitness : BaseType
    {
        ...
        /// >> owned_item
        /// </summary>
        public Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.TestNode.NET.NetApiExt.Generated.Model.primitive_types.H256> OwnedItem { get; set; }
        /// <summary>
        /// >> mint_price
        /// </summary>
        ...
        {
            var start = p;
            OwnedItem = new Substrate.NetApi.Model.Types.Base.BaseOpt<Substrate.TestNode.NET.NetApiExt.Generated.Model.primitive_types.H256>();
