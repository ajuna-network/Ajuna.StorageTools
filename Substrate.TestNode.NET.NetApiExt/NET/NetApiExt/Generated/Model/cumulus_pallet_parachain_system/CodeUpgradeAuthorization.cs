...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Model.cumulus_pallet_parachain_system
{
    
    
    /// <summary>
    /// >> 202 - Composite[cumulus_pallet_parachain_system.CodeUpgradeAuthorization]
    /// </summary>
    ...
    public sealed class CodeUpgradeAuthorization : BaseType
    {
        ...
        /// >> code_hash
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.primitive_types.H256 CodeHash { get; set; }
        /// <summary>
        /// >> check_version
        /// </summary>
        ...
        {
            var start = p;
            CodeHash = new Substrate.TestNode.NET.NetApiExt.Generated.Model.primitive_types.H256();
