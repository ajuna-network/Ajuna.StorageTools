...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_identity.types
{
    ...
    /// <summary>
    /// >> 354 - Composite[pallet_identity.types.RegistrarInfo]
    /// </summary>
    ...
    public sealed class RegistrarInfo : BaseType
    {
        ...
        /// >> account
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 Account { get; set; }
        /// <summary>
        /// >> fee
        /// </summary>
        ...
        /// >> fields
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_identity.types.BitFlags Fields { get; set; }
        ...
        {
            var start = p;
            Account = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32();
            Account.Decode(byteArray, ref p);
            Fee = new Substrate.NetApi.Model.Types.Primitive.U128();
            Fee.Decode(byteArray, ref p);
            Fields = new Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_identity.types.BitFlags();
