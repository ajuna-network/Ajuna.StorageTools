...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SessionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "Validators"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "QueuedKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.SessionKeys>>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "NextKeys"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.SessionKeys)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Session", "KeyOwner"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>>), typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32)));
        }
        ...
        ///  The current set of validators.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32>> Validators(string blockhash, CancellationToken token)
        {
        ...
        ///  will be used to determine the validator's session keys.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.SessionKeys>>> QueuedKeys(string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.QueuedKeysParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32, Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.SessionKeys>>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string NextKeysParams(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The next session keys for a validator.
        /// </summary>
        public async Task<Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.SessionKeys> NextKeys(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = SessionStorage.NextKeysParams(key);
            var result = await _client.GetStorageAsync<Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.SessionKeys>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string KeyOwnerParams(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key)
        {
        ...
        ///  The owner of a key. The key is the `KeyTypeId` + the encoded key.
        /// </summary>
        public async Task<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> KeyOwner(Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.KeyTypeId, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8>> key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class SessionCalls
    {
        ...
        /// </summary>
        public static Method SetKeys(Substrate.TestNode.NET.NetApiExt.Generated.Model.bajun_runtime.SessionKeys keys, Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Primitive.U8> proof)
        {
