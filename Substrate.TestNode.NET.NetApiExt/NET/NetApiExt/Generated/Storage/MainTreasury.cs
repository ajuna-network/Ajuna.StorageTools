...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class TreasuryStorage
    {
        ...
        public TreasuryStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Proposals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("Treasury", "Approvals"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8)));
        }
        ...
        ///  Proposals that have been made.
        /// </summary>
        public async Task<Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal> Proposals(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.ProposalsParams(key);
            var result = await _client.GetStorageAsync<Substrate.TestNode.NET.NetApiExt.Generated.Model.pallet_treasury.Proposal>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Proposal indices that have been approved but not yet awarded.
        /// </summary>
        public async Task<Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8> Approvals(string blockhash, CancellationToken token)
        {
            string parameters = TreasuryStorage.ApprovalsParams();
            var result = await _client.GetStorageAsync<Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT8>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class TreasuryCalls
    {
        ...
        /// </summary>
        public static Method ProposeSpend(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> value, Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method Spend(Substrate.NetApi.Model.Types.Base.BaseCom<Substrate.NetApi.Model.Types.Primitive.U128> amount, Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_runtime.multiaddress.EnumMultiAddress beneficiary)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    public sealed class TreasuryConstants
    {
        ...
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill ProposalBond()
        {
            var result = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
        ...
        /// </summary>
        public Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill Burn()
        {
            var result = new Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_arithmetic.per_things.Permill();
