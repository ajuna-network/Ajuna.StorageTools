...
namespace Substrate.TestNode.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class CollatorSelectionStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "Invulnerables"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "Candidates"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("CollatorSelection", "LastAuthoredBlock"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.NetApi.Model.Types.Primitive.U32)));
        ...
        ///  The invulnerable, permissioned collators. This list must be sorted.
        /// </summary>
        public async Task<Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27> Invulnerables(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.InvulnerablesParams();
            var result = await _client.GetStorageAsync<Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT27>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  mutually exclusive.
        /// </summary>
        public async Task<Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28> Candidates(string blockhash, CancellationToken token)
        {
            string parameters = CollatorSelectionStorage.CandidatesParams();
            var result = await _client.GetStorageAsync<Substrate.TestNode.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT28>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string LastAuthoredBlockParams(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  Last block authored by collator.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Primitive.U32> LastAuthoredBlock(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
    ...
    public sealed class CollatorSelectionCalls
    {
        ...
        /// </summary>
        public static Method SetInvulnerables(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32> @new)
        {
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method AddInvulnerable(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains a variant per dispatchable extrinsic that this pallet has.
        /// </summary>
        public static Method RemoveInvulnerable(Substrate.TestNode.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 who)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(who.Encode());
