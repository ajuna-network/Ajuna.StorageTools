...
namespace Ajuna.StorageTools.Client
{
    public class TargetClient
    {
        ...
        /// </summary>
        public TargetExtrinsicManager ExtrinsicManager { get; }
        ...
        public TargetClient(string url, NetworkType networkType, int maxConcurrentCalls = 10)
        {
            ...
            ExtrinsicManager = new TargetExtrinsicManager(SubstrateClient);
