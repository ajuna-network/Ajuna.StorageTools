...
namespace Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.pallet_ajuna_awesome_avatars.types.season
{
    ...
    public sealed class Season : BaseType
    {
        ...
        /// >> name
        /// </summary>
        private Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT1 _name;
        
        /// <summary>
        /// >> description
        /// </summary>
        private Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT2 _description;
        ...
        /// >> tiers
        /// </summary>
        private Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3 _tiers;
        
        /// <summary>
        /// >> single_mint_probs
        /// </summary>
        private Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT4 _singleMintProbs;
        
        /// <summary>
        /// >> batch_mint_probs
        /// </summary>
        private Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT4 _batchMintProbs;
        ...
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT1 Name
        {
            get
            {
                return this._name;
        ...
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT2 Description
        {
            get
            {
        ...
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3 Tiers
        {
            get
            {
                return this._tiers;
        ...
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT4 SingleMintProbs
        {
            get
            {
        ...
        public Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT4 BatchMintProbs
        {
            get
            {
        ...
        {
            var start = p;
            Name = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT1();
            Name.Decode(byteArray, ref p);
            Description = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT2();
            ...
            Tiers = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT3();
            Tiers.Decode(byteArray, ref p);
            SingleMintProbs = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT4();
            SingleMintProbs.Decode(byteArray, ref p);
            BatchMintProbs = new Substrate.AjunaSolo.NET.NetApiExt.Generated.Model.sp_core.bounded.bounded_vec.BoundedVecT4();
