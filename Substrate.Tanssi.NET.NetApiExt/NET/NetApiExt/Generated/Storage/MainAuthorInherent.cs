...
namespace Substrate.Tanssi.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthorInherentStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AuthorInherent", "Author"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.nimbus_primitives.nimbus_crypto.Public)));
        ...
        ///  Author of current block.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.nimbus_primitives.nimbus_crypto.Public> Author(CancellationToken token)
        {
            string parameters = AuthorInherentStorage.AuthorParams();
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.nimbus_primitives.nimbus_crypto.Public>(parameters, token);
            return result;
        }
