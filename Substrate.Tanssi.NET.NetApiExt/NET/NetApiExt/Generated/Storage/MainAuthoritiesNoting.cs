...
namespace Substrate.Tanssi.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class AuthoritiesNotingStorage
    {
        ...
        {
            this._client = client;
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AuthoritiesNoting", "OrchestratorParaId"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("AuthoritiesNoting", "Authorities"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Tanssi.NET.NetApiExt.Generated.Model.nimbus_primitives.nimbus_crypto.Public>)));
        ...
        /// >> OrchestratorParaId
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id> OrchestratorParaId(CancellationToken token)
        {
            string parameters = AuthoritiesNotingStorage.OrchestratorParaIdParams();
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id>(parameters, token);
            return result;
        }
        ...
        /// >> Authorities
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Tanssi.NET.NetApiExt.Generated.Model.nimbus_primitives.nimbus_crypto.Public>> Authorities(CancellationToken token)
        {
            string parameters = AuthoritiesNotingStorage.AuthoritiesParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Tanssi.NET.NetApiExt.Generated.Model.nimbus_primitives.nimbus_crypto.Public>>(parameters, token);
            return result;
        }
    ...
    public sealed class AuthoritiesNotingCalls
    {
        ...
        /// </summary>
        public static Method SetLatestAuthoritiesData(Substrate.Tanssi.NET.NetApiExt.Generated.Model.ccp_authorities_noting_inherent.ContainerChainAuthoritiesInherentData data)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetAuthorities(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Tanssi.NET.NetApiExt.Generated.Model.nimbus_primitives.nimbus_crypto.Public> authorities)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SetOrchestratorParaId(Substrate.Tanssi.NET.NetApiExt.Generated.Model.polkadot_parachain.primitives.Id new_para_id)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
