...
namespace Substrate.Tanssi.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SystemStorage
    {
        ...
        public SystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Account"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.AccountInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockWeight"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ParentHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Digest"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Events"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.EventRecord>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "LastRuntimeUpgrade"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ExecutionPhase"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.EnumPhase)));
        }
        ...
        /// </summary>
        public static string AccountParams(Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> Account(Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, CancellationToken token)
        {
            string parameters = SystemStorage.AccountParams(key);
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.AccountInfo>(parameters, token);
            return result;
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1> BlockWeight(CancellationToken token)
        {
            string parameters = SystemStorage.BlockWeightParams();
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1>(parameters, token);
            return result;
        }
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.primitive_types.H256> BlockHash(Substrate.NetApi.Model.Types.Primitive.U32 key, CancellationToken token)
        {
            string parameters = SystemStorage.BlockHashParams(key);
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.primitive_types.H256>(parameters, token);
            return result;
        }
        ...
        ///  Hash of the previous block.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.primitive_types.H256> ParentHash(CancellationToken token)
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> Digest(CancellationToken token)
        {
            string parameters = SystemStorage.DigestParams();
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>(parameters, token);
            return result;
        }
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> Events(CancellationToken token)
        {
            string parameters = SystemStorage.EventsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>(parameters, token);
            return result;
        }
        ...
        /// </summary>
        public static string EventTopicsParams(Substrate.Tanssi.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  no notification will be triggered thus the event might be lost.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>> EventTopics(Substrate.Tanssi.NET.NetApiExt.Generated.Model.primitive_types.H256 key, CancellationToken token)
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(CancellationToken token)
        {
            string parameters = SystemStorage.LastRuntimeUpgradeParams();
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>(parameters, token);
            return result;
        }
        ...
        ///  The execution phase of the block.
        /// </summary>
        public async Task<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhase(CancellationToken token)
        {
            string parameters = SystemStorage.ExecutionPhaseParams();
            var result = await _client.GetStorageAsync<Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.EnumPhase>(parameters, token);
            return result;
        }
    }
    ...
    public sealed class SystemConstants
    {
        ...
        /// </summary>
        public Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.limits.BlockWeights BlockWeights()
        {
            var result = new Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.limits.BlockWeights();
            result.Create("0x0203815D00070088526A7402004001C2E9171B0001079031DA76510200E000010700E6BD4F57020" +
                    "0F000010000C2E9171B00010790D36E916E0200300101070088526A7402004001010700A2941A1D0" +
        ...
        /// </summary>
        public Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.limits.BlockLength BlockLength()
        {
            var result = new Substrate.Tanssi.NET.NetApiExt.Generated.Model.frame_system.limits.BlockLength();
        ...
        /// </summary>
        public Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_weights.RuntimeDbWeight DbWeight()
        {
            var result = new Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_weights.RuntimeDbWeight();
        ...
        /// </summary>
        public Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_version.RuntimeVersion Version()
        {
            var result = new Substrate.Tanssi.NET.NetApiExt.Generated.Model.sp_version.RuntimeVersion();
            result.Create(@"");
            return result;
        }
