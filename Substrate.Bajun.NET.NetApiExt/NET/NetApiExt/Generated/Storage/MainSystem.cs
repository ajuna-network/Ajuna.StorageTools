...
namespace Substrate.Bajun.NET.NetApiExt.Generated.Storage
{
    ...
    public sealed class SystemStorage
    {
        ...
        public SystemStorage(SubstrateClientExt client)
        {
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Account"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.BlakeTwo128Concat}, typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.AccountInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockWeight"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "BlockHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(new Substrate.NetApi.Model.Meta.Storage.Hasher[] {
                            Substrate.NetApi.Model.Meta.Storage.Hasher.Twox64Concat}, typeof(Substrate.NetApi.Model.Types.Primitive.U32), typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ParentHash"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Digest"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest)));
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "Events"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.EventRecord>)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "LastRuntimeUpgrade"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo)));
            ...
            _client.StorageKeyDict.Add(new System.Tuple<string, string>("System", "ExecutionPhase"), new System.Tuple<Substrate.NetApi.Model.Meta.Storage.Hasher[], System.Type, System.Type>(null, null, typeof(Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.EnumPhase)));
        }
        ...
        /// </summary>
        public static string AccountParams(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key)
        {
        ...
        ///  The full account information for a particular account ID.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.AccountInfo> Account(Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32 key, string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.AccountParams(key);
            var result = await _client.GetStorageAsync<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.AccountInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The current weight for the block.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1> BlockWeight(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.BlockWeightParams();
            var result = await _client.GetStorageAsync<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_support.dispatch.PerDispatchClassT1>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Map of block numbers to block hashes.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256> BlockHash(Substrate.NetApi.Model.Types.Primitive.U32 key, string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.BlockHashParams(key);
            var result = await _client.GetStorageAsync<Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  Hash of the previous block.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256> ParentHash(string blockhash, CancellationToken token)
        {
        ...
        ///  Digest of the current block, also part of the block header.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest> Digest(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.DigestParams();
            var result = await _client.GetStorageAsync<Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_runtime.generic.digest.Digest>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  just in case someone still reads them from within the runtime.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.EventRecord>> Events(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.EventsParams();
            var result = await _client.GetStorageAsync<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.EventRecord>>(parameters, blockhash, token);
            return result;
        }
        ...
        /// </summary>
        public static string EventTopicsParams(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key)
        {
        ...
        ///  no notification will be triggered thus the event might be lost.
        /// </summary>
        public async Task<Substrate.NetApi.Model.Types.Base.BaseVec<Substrate.NetApi.Model.Types.Base.BaseTuple<Substrate.NetApi.Model.Types.Primitive.U32, Substrate.NetApi.Model.Types.Primitive.U32>>> EventTopics(Substrate.Bajun.NET.NetApiExt.Generated.Model.primitive_types.H256 key, string blockhash, CancellationToken token)
        {
        ...
        ///  Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo> LastRuntimeUpgrade(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.LastRuntimeUpgradeParams();
            var result = await _client.GetStorageAsync<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.LastRuntimeUpgradeInfo>(parameters, blockhash, token);
            return result;
        }
        ...
        ///  The execution phase of the block.
        /// </summary>
        public async Task<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.EnumPhase> ExecutionPhase(string blockhash, CancellationToken token)
        {
            string parameters = SystemStorage.ExecutionPhaseParams();
            var result = await _client.GetStorageAsync<Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.EnumPhase>(parameters, blockhash, token);
            return result;
        }
    }
    ...
    public sealed class SystemConstants
    {
        ...
        /// </summary>
        public Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.limits.BlockWeights BlockWeights()
        {
            var result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.limits.BlockWeights();
        ...
        /// </summary>
        public Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.limits.BlockLength BlockLength()
        {
            var result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.frame_system.limits.BlockLength();
        ...
        /// </summary>
        public Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_weights.RuntimeDbWeight DbWeight()
        {
            var result = new Substrate.Bajun.NET.NetApiExt.Generated.Model.sp_weights.RuntimeDbWeight();
